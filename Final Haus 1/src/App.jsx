...
function Header() {
  ...
  return (
    ...
    >
      <div
        className={`mt-3 flex items-center justify-between rounded-2xl sm:rounded-full px-4 sm:px-6 py-3 sm:py-3.5 border border-white/10 bg-[var(--ink)] transition-shadow duration-500 ${
          scrolled || open ? "shadow-[0_18px_40px_-28px_rgba(0,0,0,0.9)]" : ""
        }`}
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="lg:hidden rounded-2xl mt-2 p-4 bg-[#14110EF5] backdrop-blur-md border border-white/10"
